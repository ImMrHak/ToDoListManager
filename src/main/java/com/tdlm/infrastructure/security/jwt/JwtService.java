package com.tdlm.infrastructure.security.jwt;
...
public class JwtService {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails, boolean isRefreshToken) {
        ...
        final boolean isTypeCorrect = "refresh".equals(extractClaim(token, claims -> claims.get("type", String.class)));

        return username.equals(userDetails.getUsername()) && !isTokenExpired(token) && isTypeCorrect == isRefreshToken;
    }
